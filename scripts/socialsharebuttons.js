...
/*!
If you're using the Pinterest button you will also need to include the following script in the head code section.
<script async defer src="//assets.pinterest.com/js/pinit.js"></script>

If you would like to include a Twitter card add this to the head code section.
...
, function(t, e, n) {
    ...
    window.tram = function(t) {
        ...
        var O = e.frame = function() {
          ...
          , C = f(function(e) {
            ...
            function d() {
                ...
                this.el.style[j.transition.dom] = n)
            }
            function h(t, e, i) {
                var o, a, s, u, c = e !== p, f = {};
                for (o in t)
                    s = t[o],
                    o in Z ? (f.transform || (f.transform = {}),
                    f.transform[o] = s) : (w.test(o) && (o = n(o)),
                    o in Y ? f[o] = s : (u || (u = {}),
                    u[o] = s));
                for (o in f) {
                    if (s = f[o],
        ...
        j.transform && j.backface && (Z.z = [x, "translateZ"],
        Z.rotateZ = [_],
        Z.scaleZ = [b],
        Z.perspective = [y]);
        var Q = /ms/
...
, function(t, e, n) {
    ...
    i.define("links", t.exports = function(t, e) {
        var n, r, o, a = {}, s = t(window), u = i.env(), c = window.location, f = document.createElement("a"), l = "w--current", d = /index\.(html|php)$/, h = /\/$/;
        function p(e) {
