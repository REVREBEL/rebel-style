...
(function(){
  ...
  ready(function(){
    ...
    if (!wrapper || !section) {
      console.log("Share icons: wrapper or section not found");
      return;
    }
    ...
    function compute(){
      ...
      // --- DEBUGGING ---
      // Uncomment the next line to see debug information in the console
      // console.log({ progress: progress.toFixed(3), on: on, lastOn: lastOn });
      // --- END DEBUGGING ---
